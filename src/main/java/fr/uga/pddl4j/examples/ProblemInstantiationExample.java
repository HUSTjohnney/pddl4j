...
/**
 * The class is an example class. It shows how to use the library to create to
 * ground planning problem.
 *
 * @author D. Pellier
...
public class ProblemInstantiationExample {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        String path = "src\\test\\resources\\benchmarks\\hddl\\ipc2020\\satellite\\";
        String[] args0 = { path + "domain.hddl", path + "p01.hddl" };
        // Creates an instance of the PDDL parser
        final Parser parser = new Parser();
        // Parses the domain and the problem files.
        final DefaultParsedProblem parsedProblem = parser.parse(args0[0], args0[1]);
        ...
        if (!errorManager.isEmpty()) {
            ...
            System.out.print("\nparsing domain file \"" + args0[0] + "\" done successfully");
            System.out.print("\nparsing problem file \"" + args0[1] + "\" done successfully\n\n");
            // Create a problem
